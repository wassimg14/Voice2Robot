...
function App() {
  ...
  const [status, setStatus] = useState({ message: 'Ready to receive commands', type: '' });
  ...
  const getEmotionColors = () => {
    const emotionColors: { [key: string]: { body: string; accent: string } } = {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-500 via-cyan-400 to-blue-600 p-5 text-white">
      <div className="max-w-6xl mx-auto bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl p-8 shadow-2xl">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-3 text-shadow-lg">
        ...
        <div className="flex flex-col items-center gap-5 mb-8">
          <button
            ...
            className={`px-8 py-4 rounded-full text-xl font-bold transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 ${
              isRecording 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
          <div className="bg-white bg-opacity-15 backdrop-blur-sm rounded-2xl p-5">
        ...
        <div className="bg-white bg-opacity-90 rounded-2xl p-6 text-gray-800">
          <h3 className="text-xl font-semibold mb-4 text-center">Simulation Preview</h3>
          <div className="w-full h-96 border-2 border-gray-300 rounded-xl bg-white overflow-hidden">
          ...
          <div className={`mt-4 p-3 rounded-lg font-semibold text-center ${
        ...
        <div className="text-center mt-8 pt-6 border-t border-white border-opacity-20 opacity-80">
          <div className="text-lg font-semibold mb-1">Made by Wassim Gueraoui</div>
          <div className="text-sm opacity-70">
            <a href="mailto:wassimgueraoui@gmail.com" className="text-inherit no-underline">
